            ...
            query = (
                select(Hotels.id,
                       ...
                       (Hotels.rooms_quantity - func.coalesce(
                           booked_rooms.c.bookings_count, 0))
                           .label("rooms_left"))
                .select_from(Hotels)
                .join(booked_rooms,
                      Hotels.id == booked_rooms.c.hotel_id,
                      isouter=True)
                .where(
